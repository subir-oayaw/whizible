    ...
    <div className="mb-4" >
      <Accordion className='accordionbg' defaultExpanded>
        ...
        <div class="row">
          ...
          <Label htmlFor="filter_AuditType">Audit Type</Label>
            <TextField id="filter_AuditType" value={formValues.filter_AuditType} onChange={handleInputChange} placeholder="Financial audit"/>
         </div>
         <div class="col-sm-4 mb-2">
            <Label htmlFor="filter_Description">Description</Label>
            <TextField id="filter_Description" multiline
                rows={2} value={formValues.filter_Description} onChange={handleInputChange} placeholder="Test"/>
          </div>
...
export default Accor_AuditType
