...
import Details_AuditType_Defin from './Details_AuditType_Defin';
import AuditTypeDefiInfo_Hist_Tbl from './History_Currency';

const Drawer_AuditType_Defin = ({ visible, onClose }) => {
  ...
  return (
    <Drawer anchor="right" open={visible} onClose={onClose} ModalProps={{ keepMounted: true }} headerText="healthsheet Section Details" closeButtonAriaLabel="Close">
     ...
     <Text>Audit Type Definition Details</Text>
...
export default Drawer_AuditType_Defin;
