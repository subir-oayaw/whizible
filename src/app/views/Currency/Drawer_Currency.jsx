...
import Details_Currency from './Details_Currency';
import CurrencyInfo_Hist_Tbl from './History_Currency';

const Drawer_Currency = ({ visible, onClose }) => {
...
export default Drawer_Currency;
