...
import Drawer_Currency from "./Drawer_Currency";
import Accor_Currency from "./Accor_Currency";


const Currency_Table = ({ index }) => {
  ...
  const [individualChecks, setIndividualChecks] = useState(CurrencyInfo_Section.map(() => false));
    ...
    <div className='mx-4 mt-3'>
         <div className="row align-items-end mb-3">
              ...
              <Drawer_Currency visible={DrawerVisible} onClose={() => setDrawerVisible(false)}/>
             </div>
        {showForm && <Accor_Currency className='mb-3' onClose={handleCloseForm} />}
        <Box sx={{height:340}}>
   <TableContainer component={Paper} className="mt-3">
      <Table>
        ...
        <TableRow>
            ...
            <TableCell align="center">Conversion Rate <br></br> 
            (Value Vs. Base Currency)</TableCell>
        ...
        <TableBody>
          {currentData.map((healthsheet, index) => (
            <TableRow
              ...
              <TableCell align="center">{healthsheet.Code}</TableCell>
              <TableCell align="center"><Link href="javascript:;" id="ClearSearchBtn" className="closelink" onClick={() => setDrawerVisible(true)}>{healthsheet.Name }</Link></TableCell>
              <TableCell align="center">{healthsheet.Symbol}</TableCell>
              <TableCell align="center">{healthsheet.Rate}</TableCell>
              <TableCell align="center">{healthsheet.Major}</TableCell>
              <TableCell align="center">{healthsheet.Minor}</TableCell>
