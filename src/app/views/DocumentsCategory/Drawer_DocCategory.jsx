...
import Details_DocCategory from './Details_DocCategory';
import DocCategory_Hist_Tbl from './History_Currency';

const Drawer_DocCategory = ({ visible, onClose }) => {
  ...
  return (
    <Drawer anchor="right" open={visible} onClose={onClose} ModalProps={{ keepMounted: true }} headerText="healthsheet Section Details" closeButtonAriaLabel="Close">
     ...
     <Text> Documents Category Details</Text>
...
export default Drawer_DocCategory;
