...
const Details_DocCategory = ({ onClose }) => {
    const Country_grid = {
       CategoryType: "",
        Dire_name: "",
      };
  ...
  <div className="row mt-1">
   ...
   <div className='col-sm-4'>
     <Stack.Item grow={1}>
       ...
       <TextField id="CategoryType" value={formValues.CategoryType} onChange={handleInputChange} placeholder="India"/>
     </Stack.Item>
     </div>
   <div className='col-sm-4'>
     <Stack.Item grow={1}>
     <Label htmlFor="Dire_name">Directory Name</Label>
            <TextField id="Dire_name" value={formValues.Dire_name} onChange={handleInputChange} placeholder="Test"/>
         </Stack.Item>
     </div>
...
export default Details_DocCategory;
