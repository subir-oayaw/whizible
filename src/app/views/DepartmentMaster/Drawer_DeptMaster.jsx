...
import DepartmentMaster_Hist_Tbl from './History_DeptMaster';
import Details_DeptMaster from './Details_DeptMaster';

const Drawer_DeptMaster = ({ visible, onClose }) => {
...
export default Drawer_DeptMaster;
