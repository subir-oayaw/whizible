...
const InitiativeCard = ({ initiative, setIsEditing, startEditing, stopEditing }) => {
  ...
  const { title, createdOn, inboxForInitiativeDetails, originator } = initiative;
  ...
  const handleViewEdit = () => {
    // Implement action for View/Edit
    // Example: setIsEditing(true);
    handleClose();
  };
  ...
  const handleDiscussions = () => {
    // Implement action for Discussions
    // Example: open offcanvas for discussions
    handleClose();
  };
