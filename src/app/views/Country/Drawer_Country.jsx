...
import Details_Country from './Details_Country';
import CountryInformation_Hist_Tbl from './History_Currency';

const Drawer_Country = ({ visible, onClose }) => {
